  ...
  return (
    <div className='bg-slate-800 w-screen h-screen flex flex-row '>
      ...
      <div className='left  w-2/5  h-screen '>
        <h1 className='text-white font-thin w-3/4 text-5xl p-8 leading-tight relative top-1/4 left-10 whitespace-pre-wrap '>
          <span className='font-medium text-yellow-500 text-8xl'>FinTrax</span>
          <br />
          <br />
